...
switch mode
    case 1
        fprintf('Total mass and cg. [[x y], M] - Wikipedia Collapsing conditions');
        M1 =[[25,35] 2]
        M2 =[[66,42] 5]
        
        fprintf('description of each contact [b1,b2,x,y,Contact Normal,u] - - Wikipedia Collapsing conditions');
    ...
    case 2
        fprintf('Total mass and cg. [[x y], M]- Wikipedia Stable conditions');
        M1 =[[25,35] 2]
        M2 =[[66,42] 10]
        
        fprintf('description of each contact [b1,b2,x,y,Contact Normal,u] - Wikipedia Stable conditions');
    ...
    case 3
        fprintf('Total mass and cg. [[x y], M]- Figure 12.27 Collapsing conditions');
        M1 =[[-20,35] 1]
        M2 =[[20,30] 1]
        M3 =[[40,0] 20]
        
        fprintf('description of each contact [b1,b2,x,y,Contact Normal,u] - Figure 12.27 Collapsing conditions');
    ...
    case 4
        fprintf('Total mass and cg. [[x y], M] - Figure 12.27 Stable conditions')
        M1 =[[-20,35] 20]
        M2 =[[20,30] 30]
        M3 =[[40,0] 5]
        
        fprintf('description of each contact [b1,b2,x,y,Contact Normal,u] - Figure 12.27 Stable conditions');
